...
//chart.js set up    
  ...
  componentWillUpdate(nextProps,nextState){
    if(nextState.pastStepCount!=this.state.pastStepCount){
      ...
      const weekColumn = { totalSteps : nextState.pastStepCount+nextState.currentStepCount };
      const dayColumn = { weekName, steps: nextState.pastStepCount+nextState.currentStepCount };
      let pace = 0;
    ...
    weeklyData[stepUpdateId+1]=(nextState.pastStepCount+nextState.currentStepCount).toString();
    console.log('_______',nextState.pastStepCount+nextState.currentStepCount)
